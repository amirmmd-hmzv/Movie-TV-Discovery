/**
 * SignUpPage — New user registration with email and password validation.
 * Enforces password requirements and confirms password match.
 * Unauthenticated users only (protected by GuestRoute).
 */
